...
plugins=(
#  git # Gives aliases for git, I don't like them
  fzf # Great for <C-r> history fzf and <C-t> file finding (or ** for including the hidden files too)
  z
  command-not-found
)
...
__nvm_lazy_load() {
  ...
  # The fix: --no-use sourcing flag, and nvm use default --silent
  ...
  nvm use default --silent # You need this to load up npm packages
